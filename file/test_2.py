...
def Time_draw(rtime):
    pg.draw.rect(Screen,'white',(0,0,150,50))
    Font = pg.font.Font(None,50)
    time_is = Font.render(f"{rtime}",False,'red')
    time_rect = time_is.get_rect(center = (75,25))
    Screen.blit(time_is,time_rect)
